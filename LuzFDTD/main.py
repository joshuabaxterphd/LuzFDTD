...
from FDTD2D_jax import FDTD_2D
...
for direction in directions:
    ...
    if direction == "+x":
        fluxes = [{"direction": "+x","center":[-simulation_sizex/2 + 2.0e-6, 0, 0],"size":[0,4e-6],"wavelengths": wavelengths, "mode": mode}]
        fluxes += [{"direction": "+x","center":[simulation_sizex/2 - 1.0e-6, 0, 0],"size":[0,4e-6],"wavelengths": wavelengths, "mode": mode}]
        fluxes += [{"direction": "+x","center":[-simulation_sizex/2 + 1.0e-6, 0, 0],"size":[0,4e-6],"wavelengths": wavelengths, "mode": mode}]
        geometry = [{"type":"rectangle","size":[simulation_sizex,0.5e-6,0],"center":[0,0,0], "refractive index": 3.0}]
        source = [{"type":"mode","size":[0,5e-6,0],"center":[-simulation_sizex/2+1.5e-6,0,0], "mode": mode, "wavelength":1.55e-6,"direction":direction}]
    ...
    if direction == "+y":
        fluxes = [{"direction": "+y","center":[0,-simulation_sizey/2+2.0e-6, 0],"size":[5e-6,0],"wavelengths": wavelengths, "mode": mode}]
        fluxes += [{"direction": "+y","center":[0, simulation_sizey/2 - 1.0e-6, 0],"size":[5e-6,0],"wavelengths": wavelengths, "mode": mode}]
        fluxes += [{"direction": "+y","center":[0, -simulation_sizey/2 + 1.0e-6, 0],"size":[5e-6,0],"wavelengths": wavelengths, "mode": mode}]
        geometry = [{"type":"rectangle","size":[0.5e-6,simulation_sizey,0],"center":[0,0,0], "refractive index": 3.0}]
        source = [{"type":"mode","size":[5e-6,0,0],"center":[0,-simulation_sizey/2+1.5e-6,0], "mode": mode, "wavelength":1.55e-6,"direction":direction}]
